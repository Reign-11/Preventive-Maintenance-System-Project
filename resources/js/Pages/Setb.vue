      ...
      <div class="container mt-4">
        ...
        <div class="text-center">
          ...
          <div class="d-flex justify-content-center gap-4 mt-3 no-print">
            ...
            <button 
              class="btn btn-warning rounded-pill shadow-sm px-4 py-2" 
                ...
                <thead>
                  <tr class="custom-header-bg">
                    ...
                    <th 
                      ...
                      :key="month" 
                      class="py-3 text-center fw-bold fs-6 border-bottom border-2"
                    >
                      {{ month }}
                    </th>
...
@media print {
  ...
  /* Make sure the Set B title is visible */
